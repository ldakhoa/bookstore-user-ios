...
class LocationTopView: UIView {
    let locationLabel = UILabel(text: "Delivery to Khoa - Ho Chi Minh 700000", font: Styles.Text.location.preferredFont, textColor: UIColor.black, numberOfLines: 1)
    ...
    override func awakeFromNib() {
        ...
        stackview.anchor(top: nil, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: .init(top: 0, left: 15, bottom: 0, right: 15))
